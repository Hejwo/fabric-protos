...
| CommitStatus | [SignedCommitStatusRequest](#gateway-SignedCommitStatusRequest) | [CommitStatusResponse](#gateway-CommitStatusResponse) | The CommitStatus service will indicate whether a prepared transaction previously submitted to the Submit sevice has been committed. It will wait for the commit to occur if it hasn’t already committed. |
